...
- [NETWORK](api/NETWORK.md) - HTTP requests, WebSockets, and Socket.IO, URL resolution, and caching.
...
- [IO](api/IO.md) - one Socket.IO connection (host runs `socket.io-client`).
